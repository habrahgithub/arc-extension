...
**Output:** `artifacts/releases/arc-audit-ready-core-0.1.7.vsix`
...
4. Select `artifacts/releases/arc-audit-ready-core-0.1.7.vsix`
...
npm run pack
sha256sum artifacts/releases/arc-audit-ready-core-0.1.7.vsix  # Record for verification
```
...
- **VSIX Package:** `artifacts/releases/arc-audit-ready-core-0.1.7.vsix` (retained)
