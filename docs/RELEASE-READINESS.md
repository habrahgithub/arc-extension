...
**Output:** `lintel-0.1.5.vsix` in project root
...
npm run pack
sha256sum lintel-0.1.5.vsix  # Record for verification
```
...
- **VSIX Package:** `dist/release/lintel-0.1.5.vsix` (retained)
