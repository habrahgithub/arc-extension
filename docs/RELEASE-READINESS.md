...
**Output:** `artifacts/releases/arc-audit-ready-core-0.1.5.vsix`
...
4. Select `artifacts/releases/arc-audit-ready-core-0.1.5.vsix`
...
npm run pack
sha256sum artifacts/releases/arc-audit-ready-core-0.1.5.vsix  # Record for verification
```
...
- **VSIX Package:** `artifacts/releases/arc-audit-ready-core-0.1.5.vsix` (retained)
